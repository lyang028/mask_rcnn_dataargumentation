...
def train(model):
    ...
    dataset_train.load_worker(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = WorkerDataset()
    dataset_val.load_worker(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect action.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/worker/dataset/",
                        help='Directory of the worker dataset')
    ...
    if args.command == "train":
        ...
        class InferenceConfig(WorkerConfig):
